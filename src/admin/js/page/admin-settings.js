...
import { BulkProgressStatsProvider } from '~cimo/admin/js/bulk-optimizer/use-bulk-progress-stats'
import { PremiumSavingsEstimate } from './premium-savings-estimate'
...
const AdminSettings = () => {
	...
	return (
		<BulkProgressStatsProvider enabled={ buildType === 'free' }>
				...
				<div className="cimo-header">
					...
					<div className="cimo-stats-section" id="cimo-stats">
						<div className="cimo-stats-column cimo-stats-column-big">
							...
							{ buildType === 'free' && <PremiumSavingsEstimate /> }
						</div>

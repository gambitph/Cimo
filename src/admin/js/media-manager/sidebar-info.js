...
function injectCimoMetadata( {
	...
	if ( showPremiumHint ) {
		...
		html += `<p class="cimo-media-premium-hint"><a href="${ escape( premiumUrl ) }" target="_blank" rel="noopener noreferrer">${ escape( __( 'Bulk optimize the rest of your Media Library →', 'cimo-image-optimizer' ) ) }</a></p>`
	}
